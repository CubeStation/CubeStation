...
function name_directory_export()
{
    ...
    $names = name_directory_get_directory_names($directory['id']);
    ...
    echo '<a href="' . admin_url('options-general.php') . '?page=name-directory">' . __('Go to Name Directory Overview', 'name-directory') . '</a>';
