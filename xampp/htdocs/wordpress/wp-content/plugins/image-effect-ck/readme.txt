...
Image Effect CK allows you to add some nice effects on your images into your editor.

== Description ==

<p>Image Effect CK allows you to add some nice effects on your images into your editor. You just have to add the needed CSS class or attribute on the desired images.</p>
...
1. Unzip the package `image-effect-ck.zip`
2. Upload the folder `image-effect-ck` to the `/wp-content/plugins/` directory
